...
E_C("CREATE TABLE `phome_ecms_infoclass_news` (
  ...
  `zz_pcid` text NOT NULL,
  `z_pcid` varchar(255) NOT NULL,
  `qz_pcid` varchar(255) NOT NULL,
  `save_pcid` varchar(10) NOT NULL,
  `zz_phoneid` text NOT NULL,
  `z_phoneid` varchar(255) NOT NULL,
  `qz_phoneid` varchar(255) NOT NULL,
  `save_phoneid` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
