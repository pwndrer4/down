...
$ecms_config['esafe']['ecookiernd']='I0KkeBIrrYOzdbqo9Xu4GHdp93qnbm';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='kbtno';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='ieuid';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='50FAJS6mCL5mMzRpu5cWnOYGyNHLJ1';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='ban5Hmn6S1MF57j6S2bOWHbnKFRiUo';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
'modmemberedittran'=>0,
'modinfoedittran'=>0,
'deftempid'=>0,'add_weburl'=>'http://xpgod.zuseng.com','add_murl'=>'http://m-xpgod.zuseng.com','add_weburl2'=>'xpgod.zuseng.com','add_beianhao'=>'粤ICP备15093131号-1','add_tongji'=>'','add_webname'=>'仿系统天堂');
//------------e_public
