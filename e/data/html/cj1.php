...
?>  <tr bgcolor="#FFFFFF"> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>电脑软件/游戏ID正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--pcid--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_pcid]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_pcid]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_pcid]" type="text" id="add[z_pcid]" value="<?=stripSlashes($r[z_pcid])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>手机软件/游戏ID正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--phoneid--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_phoneid]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_phoneid]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_phoneid]" type="text" id="add[z_phoneid]" value="<?=stripSlashes($r[z_phoneid])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
