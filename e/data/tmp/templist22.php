...
<div id="main">
   ...
   <div class="zt_main">
      <div class="zt_left">
         <div class="zt_title">
           		   <p class="name yx"><span>游戏专题</span></p>
            <p class="bnt"><a href="/rjzt/" rel="0">进入软件专题</a></p>
			         </div>
         <div class="ztph">
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select * from phome_enewszt where classid in (92) order by rand() desc limit 3',10,24,0);
if($ecms_bq_sql){
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('select * from phome_enewszt where classid in (92) order by rand() desc limit 3,7',10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
