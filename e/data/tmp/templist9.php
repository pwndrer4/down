...
?>
   ...
   <div class="nav_menu">
    ...
    <div class="zjgx"> 
   <div class="location">位置：<a href="/">首页</a><em>&gt;</em><a href="/article/">文章资讯</a><em>&gt;</em><a href="/article/zuijinlist/">最近更新</a><em>&gt;</em></div>        
<div class="letter-index s-yellow morelist">
<ul><li><a href="/article/zuijinlist/">最近更新</a> </li><li><a href="/article/bestlist/">推荐文章</a> </li><li><a href="/article/hotlist/">热门文章</a> </li></ul>
<div style="clear:both;"></div>
        ...
        <div class="newsoft-warp">
            ...
            <div class="newsoft-list s-green mt5">
                <div class="s-hd">
                    <div class="soft-xzzx">
                        <div class="s-name" style="width:550px;">文章名称</div>
...
if($pagenum==1){$youlian="block";}else{$youlian="none";}
