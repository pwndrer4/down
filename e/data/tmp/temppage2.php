...
<div id="wrap" class="w960">	<div id="header" class="cf"> </div>
   <div class="location">
       位置：<a href="/">首页</a><em>&gt;</em><a href="/support/about.html">关于本站</a><em>&gt;</em>   </div>      
<div id="container">
  		<div id="mainBody" class="clearfix">
        	<div class="main">
            	<h2>关于我们</h2>
                <p>　　XP<?=$public_r['add_webname']?>(xpgod.zuseng.com)是个专业的软件下载网站,以杀毒软件,浏览器,单机游戏,手机软件为主,为广大软件爱好者打造软件下载和学习的乐园!</p>
<p>　　PC端合作/下载器合作QQ:21617372</p>
<p>　　移动端合作QQ:21617372</p>
            </div>
            <div class="side">
            	<ul>
                	<li><a href="/support/about.html" class="cur">关于本站</a></li>
