...
<div id="wrap" class="w960">	<div id="header" class="cf"> </div>
   <div class="location">
       位置：<a href="/">首页</a><em>&gt;</em><a href="/support/link.html">友情链接</a><em>&gt;</em>   </div>      
<div id="container">
...
<div class="ylmf-page"></div>
            </div>
                        <p>1、首页链接 PR&gt;=5、百度权重&gt;=7、世界排名1万以内、各搜索引擎收录良好、行业知名网站优先。<br>
2、频道链接 PR&gt;=4、百度权重&gt;=5、世界排名20万以内、各搜索引擎收录良好、行业知名网站优先。<br>
3、友链内页 PR&gt;=3、各搜索引擎收录良好、内容健康。<br>
4、为了维护网站首页友链的权重，首页友链网站搜索引擎降权，移至内页，权重上来后再链到首页。 <br>
            </p>
            </div>
            <div class="side">
            	<ul>
                    ...
                    <li><a href="/support/link.html" class="cur">友情链接</a></li>
