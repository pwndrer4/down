...
function sys_ShowListPage($num,$pagenum,$dolink,$dotype,$page,$lencord,$ok,$search="",$add){
	...
	if($pagenum<>1)
	{
		$pagetop="<a href='".$dolink.$add['dofile'].$dotype."' target=\"_self\">".$fun_r['startpage']."</a>&nbsp;&nbsp;";
	}
	else
	{
	...
	if($pagenum<>1)
	{
		...
		$pagepri="<a href='".$dolink.$prido."' target=\"_self\">".$fun_r['pripage']."</a>&nbsp;&nbsp;";
	}
	else
	{
	...
	if($pagenum<>$page)
	{
		...
		$pagenext="<a href='".$nextpagelink."' target=\"_self\">".$fun_r['nextpage']."</a>&nbsp;&nbsp;";
	}
	else
	{
	...
	else
	{
		...
		$pageeof="<a href='".$lastpagelink."' target=\"_self\">".$fun_r['lastpage']."</a>";
	}
	$options="";
	//取得下拉页码
	if(empty($search))
...
function sys_ShowListMorePage($num,$page,$dolink,$type,$totalpage,$line,$ok,$search="",$add){
	...
	$firststr0='<a title="Total record" target=\"_self\">&nbsp;<b>'.$num.'</b> </a>&nbsp;&nbsp;';
	//上一页
	if($page==1)
	{
		$toppage='<a class="zi none" target=\"_self\"><em></em></a>';
		$prepage='<a class="pre none" target=\"_self\"><em></em></a>';
	}
	...
	if($page<>1)
	{
		...
		$prepage='<a href="'.$dolink.$prido.'" class="pre" target=\"_self\"><em></em></a>';
	}
	//下一页
	
	if($page==$totalpage)
	{
		$nextpage='<a class="next none" target=\"_self\"><em></em></a>';
		$lastpage='<a class="zi none" target=\"_self\"><em></em></a>';
	}
	...
	if($page!=$totalpage)
	{
		...
		$nextpage='<a href="'.$nextpagelink.'" class="next" target=\"_self\"><em></em></a>';
		$lastpage='<a href="'.$lastpagelink.'" target=\"_self\"></a>';
	}
	...
	for($i=$starti;$i<=$totalpage&&$no<$page_line;$i++)
	{
		...
		elseif($i==1)
		{
			$is_1='<span><a href="'.$dolink.$add['dofile'].$type.'" target=\"_self\">';
			$is_2="</a></span>";
		}
		else
		{
			$thispagelink=$repagenum&&$repagenum<$i?eReturnRewritePageLink2($add,$i):$dolink.$add['dofile'].'_'.$i.$type;
			$is_1='<span><a href="'.$thispagelink.'" target=\"_self\">';
			$is_2="</a></span>";
		}
...
function sys_ShowTextPage($totalpage,$page,$dolink,$add,$type,$search=""){
	...
	$snum=2;
	//$totalpage=ceil($num/$line);//取得总页数
	$firststr0='<a title="Page" target=\"_self\">&nbsp;<b>'.$page.'</b>/<b>'.$totalpage.'</b> </a>&nbsp;&nbsp;';
	//上一页
	if($page==1)
	{
		$toppage='<a class="zi none" target=\"_self\"><em>'.$fun_r['startpage'].'</em></a>';
		$prepage='<a class="pre none" target=\"_self\"><em></em></a>';
	}
	if($page<>1)
	{
		$toppage='<span><a href="'.$dolink.$add[filename].$type.'" target=\"_self\">'.$fun_r['startpage'].'</a></span>';
		$pagepr=$page-1;
		if($pagepr==1)
		{
		...
		$prepage='<span><a href="'.$dolink.$prido.'" class="pre" target=\"_self\"><em></em></a></span>';
	}
	//下一页
	if($page==$totalpage)
	{
		$nextpage='<span><a class="next none" target=\"_self\"><em></em></a></span>';
		$lastpage='<span><a class="zi none" target=\"_self\"><em>'.$fun_r['lastpage'].'</em></a></span>';
	}
	if($page!=$totalpage)
	{
		$pagenex=$page+1;
		$nextpage='<span><a href="'.$dolink.$add[filename].'_'.$pagenex.$type.'" class="next" target=\"_self\"><em></em></a></span>';
		$lastpage='<span><a href="'.$dolink.$add[filename].'_'.$totalpage.$type.'" target=\"_self\">'.$fun_r['lastpage'].'</a></span>';
	}
	$starti=$page-$snum<1?1:$page-$snum;
	$no=0;
	for($i=$starti;$i<=$totalpage&&$no<$page_line;$i++)
	{
		...
		if($page==$i)
		{
			$is_1="<span><a class=\"next none\" target=\"_self\">";
			$is_2="</a></span>";
		}
		elseif($i==1)
		{
			$is_1='<span><a href="'.$dolink.$add[filename].$type.'" target=\"_self\">';
			$is_2="</a></span>";
		}
		else
		{
			$is_1='<span><a href="'.$dolink.$add[filename].'_'.$i.$type.'" target=\"_self\">';
			$is_2="</a></span>";
		}
		$returnstr.=$is_1.$i.$is_2;
	}
	$returnstr="<div class=\"page\">".$prepage.$returnstr.$nextpage."</div>";
	return $returnstr;
}
