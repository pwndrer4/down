...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏类型(软件不用选)</td><td bgcolor='ffffff'><select name="yxlx" id="yxlx"><option value="无"<?=$r[yxlx]=="无"||$ecmsfirstpost==1?' selected':''?>>无</option><option value="单机"<?=$r[yxlx]=="单机"?' selected':''?>>单机</option><option value="网游"<?=$r[yxlx]=="网游"?' selected':''?>>网游</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>授权</td><td bgcolor='ffffff'><select name="shouquan" id="shouquan"><option value="免费版"<?=$r[shouquan]=="免费版"||$ecmsfirstpost==1?' selected':''?>>免费版</option><option value="官方版"<?=$r[shouquan]=="官方版"?' selected':''?>>官方版</option><option value="破解版"<?=$r[shouquan]=="破解版"?' selected':''?>>破解版</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>评分</td><td bgcolor='ffffff'>
<input name="pingfen" type="text" id="pingfen" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[pingfen]))?>" size="8.0">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>安卓盗链下载地址</td><td bgcolor='ffffff'><input name="down" type="text" id="down" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[down]))?>" size="45">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>安卓本地下载地址</td><td bgcolor='ffffff'><input name="bendidown" type="text" id="bendidown" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[bendidown]))?>" size="45">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>iTunes下载地址</td><td bgcolor='ffffff'><input name="itunes" type="text" id="itunes" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[itunes]))?>" size="47">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>IOS越狱版盗链下载地址</td><td bgcolor='ffffff'><input name="iosyy" type="text" id="iosyy" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[iosyy]))?>" size="47">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>IOS越狱版本地下载地址</td><td bgcolor='ffffff'>
<input name="iosyybendi" type="text" id="iosyybendi" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[iosyybendi]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=iosyybendi<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的文件"><img src="../data/images/changefile.gif" border="0" align="absbottom"></a>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>电脑版下载地址</td><td bgcolor='ffffff'>
<input name="pcdown" type="text" id="pcdown" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[pcdown]))?>" size="47">
</td></tr><tr><td height=25 colspan=2 bgcolor='ffffff'><div align=left>正文介绍</div></td></tr></table><div style='background-color:#D0D0D0'><?=ECMS_ShowEditorVar("newstext",$ecmsfirstpost==1?"":stripSlashes($r[newstext]),"Default","","300","100%")?>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>踩</td><td bgcolor='ffffff'>
<input name="diggdown" type="text" id="diggdown" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[diggdown]))?>" size="">
</td></tr></table>