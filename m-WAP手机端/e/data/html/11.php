...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>电脑软件/游戏ID</td><td bgcolor='ffffff'><input name="pcid" type="text" id="pcid" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[pcid]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>手机软件/游戏ID</td><td bgcolor='ffffff'>
<input name="phoneid" type="text" id="phoneid" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[phoneid]))?>" size="">
