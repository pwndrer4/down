...
</td></tr><tr><td bgcolor=ffffff>副标题</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>软件LOGO</td><td bgcolor=ffffff><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>软件截图</td><td bgcolor=ffffff>
<script>
function dopicadd()
{var i;
var str="";
...
</td></tr><tr><td bgcolor=ffffff>软件简写名（例如：千牛、QQ）</td><td bgcolor=ffffff>
...
</td></tr><tr><td bgcolor=ffffff>语言</td><td bgcolor=ffffff><select name="yuyan" id="yuyan"><option value="简体中文"<?=$r[yuyan]=="简体中文"||$ecmsfirstpost==1?' selected':''?>>简体中文</option><option value="英文"<?=$r[yuyan]=="英文"?' selected':''?>>英文</option></select></td></tr><tr><td bgcolor=ffffff>大小</td><td bgcolor=ffffff>
<input name="daxiao" type="text" id="daxiao" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[daxiao]))?>" size="">
</td></tr><tr><td bgcolor=ffffff>授权</td><td bgcolor=ffffff><select name="shouquan" id="shouquan"><option value="免费版"<?=$r[shouquan]=="免费版"||$ecmsfirstpost==1?' selected':''?>>免费版</option><option value="官方版"<?=$r[shouquan]=="官方版"?' selected':''?>>官方版</option><option value="绿色版"<?=$r[shouquan]=="绿色版"?' selected':''?>>绿色版</option><option value="破解版"<?=$r[shouquan]=="破解版"?' selected':''?>>破解版</option></select></td></tr><tr><td bgcolor=ffffff>平台</td><td bgcolor=ffffff>
