...
setTimeout(function(){
var lilen= $(".showcase .scrollbar li").length,
    lew=$(".showcase .s-content li img").width(),
	leftw=lew/2+9;
    if(lilen==1){
	$(".showcase .slider .prev, .showcase .slider .next").hide();
	$(".showcase .s-content").css("left",50+"%");
	$(".showcase .s-content").css("margin-left",-leftw+"px");
	$(".showcase .scrollbar li.picture .info,.showcase .scrollbar li img").click(function () {
		$(".showcase .s-content").css("left",0);
	    $(".showcase .s-content").css("margin-left",0);
	})
	$(".showcase .slider .trigger").click(function () {
		$(".showcase .s-content").css("left",50+"%");
	    $(".showcase .s-content").css("margin-left",-leftw+"px");
	})
