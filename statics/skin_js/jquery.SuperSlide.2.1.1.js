...
//首页
$(function(){
			$("#focus").hover(function(){$("#focus-prev,#focus-next").show();},function(){$("#focus-prev,#focus-next").show();});
			$("#focus").slide({ 
...
//文章首页
$(function(){
			$("#artfocus").hover(function(){$("#art_prev,#art_next").show();},function(){$("#art_prev,#art_next").show();});
			$("#artfocus").slide({ 
				mainCell:"#artfocus_box .artfocus_bar",
				targetCell:"#artfocus_tit a",
				titCell:"#artfocus_num a",
				prevCell:"#art_prev",
				nextCell:"#art_next",
				effect:"fold",
				easing:"swing",
...
$(function(){
			$("#arttu").slide({ 
				mainCell:"#arttu_box ul",
				targetCell:"#arttu_tit .nr",
				titCell:"#arttu_num a",
				prevCell:"#arttu_prev",
				nextCell:"#arttu_next",
				effect:"fold",
...
//专题内页
$(function(){
			//$("#ztfocus").hover(function(){$("#ztfocus_prev,#ztfocus_next").show();},function(){$("#ztfocus_prev,#ztfocus_next").show();});
			$("#ztfocus").slide({ 
				mainCell:"#ztfocus_box ul",
				targetCell:"#ztfocus_title a",
				titCell:"#ztfocus-num a",
				prevCell:"#ztfocus_prev",
				nextCell:"#ztfocus_next",
				effect:"fold",
				easing:"swing",
				autoPlay:true,
				delayTime:1000
