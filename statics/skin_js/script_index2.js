...
(function($) {
  $.fn.rglSlide=function(opt){
    ...
    $("#partner").rglSlide({productScrollWitch:"ul",ast:"ul > li",row:3,seeColumn:12,step:12,isAutoPlay:{timer:3000,rescrollTime:false,orientation:"left"},isBtn:{step:2,left:"#partnerPrev",right:"#partnerNext",disableCss:"disable"}});
